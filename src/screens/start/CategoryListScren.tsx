...
useEffect(() => {
    setCategoriesData([{"name":"Restaurant","icon":"🍽️","id":1},{"name":"Sight","icon":"🏛️","id":2},{"name":"Shop","icon":"🛍️","id":3},{"name":"Museum","icon":"🖼️️️","id":4},{"name":"Hotel","icon":"🛏️","id":5},{"name":"Club","icon":"🪩","id":6},{"name":"Park","icon":"🛝","id":7},{"name":"Hospital","icon":"🏨","id":8}])
  setTimeout(() => {
    setloading(false)
  }, 800);
