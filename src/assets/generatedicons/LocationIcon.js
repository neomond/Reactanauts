...
const SvgLocationIcon = props => (
  <Svg
    ...
    viewBox="0 0 10 11"
    {...props}>
    <Path fill="url(#LocationIcon_svg__a)" d="M0 10.7h10V.7H0v10Z" />
    <Defs>
      <Pattern
        id="LocationIcon_svg__a"
        width={1}
        height={1}
        patternContentUnits="objectBoundingBox">
        <Use xlinkHref="#LocationIcon_svg__b" transform="scale(.01563)" />
      </Pattern>
      <Image
