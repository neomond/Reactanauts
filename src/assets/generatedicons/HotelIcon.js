...
const SvgHotelIcon = props => (
  <Svg
    ...
    viewBox="0 0 37 37"
    {...props}>
    <Path fill="url(#HotelIcon_svg__a)" d="M.5 36.52h36v-36H.5v36Z" />
    <Defs>
      <Pattern
        id="HotelIcon_svg__a"
        width={1}
        ...
        <Use xlinkHref="#HotelIcon_svg__b" transform="scale(.01563)" />
      </Pattern>
      <Image
